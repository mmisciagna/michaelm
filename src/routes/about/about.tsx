    ...
    <>
      <section className="mm-section mm-about__intro">
        <div className=" mm-grid">
          <InView threshold={.3} triggerOnce={true}>
            {({inView, ref}) => (
              <div ref={ref} className={`mm-animate ${setAnimateInClassName(inView)} mm-grid__col-r` }>
      ...
      <section className="mm-section mm-section--full-bleed mm-about__tldr">
        <div className="mm-grid mm-section__inner">
          <InView threshold={.3} triggerOnce={true}>
            {({inView, ref}) => (
              <div ref={ref} className={`mm-animate ${setAnimateInClassName(inView)} mm-grid__col-l`}>
