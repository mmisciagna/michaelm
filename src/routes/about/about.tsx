...
const Intro = () => {
  return (
    <>
      ...
      <section className="mm-section mm-section--full-bleed mm-about__intro">
        <div className="mm-grid mm-section__inner">
          <div className="mm-grid__col-l">
            <h2>TL;DR</h2>
          </div>
          <div className="mm-grid__col-r">
            <h3>Sr. UX Engineer at Google,<br />with over 12+ years of experience.</h3>
            ...
            <h3>I care about performance</h3>
