export const INTRO = [
  ...
  },
  {
    ...
    paragraphs: [
      `As someone with both UX and UI design experience, as well as engineering expertise, I am able to create designs that are responsive across all devices and screen sizes. Additionally, I am able to quickly create and test prototypes within the browser.`,
    ],
  },
  {
