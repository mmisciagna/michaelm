export default function Tooltip({
  ...
  return (
    <span className="hover:border-bronze-300 dark:hover:border-bronze-300 group relative z-50 my-1 inline cursor-help border-b-2 border-dotted border-slate-800 dark:border-off-white">
      {trigger}
