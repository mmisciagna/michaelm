      ...
      <div className="pointer-events-none relative z-10 flex items-center">
        ...
        <div className="flex h-[var(--header-height)] w-0 items-center justify-center overflow-hidden bg-beige duration-200 ease-in-out [transition-property:width] dark:w-48">
          <Icons
            ...
            className="absolute left-1/2 top-1/2 h-24 w-24 -translate-x-1/2 -translate-y-1/2 opacity-0 transition duration-200 ease-in-out group-hover:fill-slate-900 dark:opacity-100"
          />
        </div>
      </div>
    </div>
